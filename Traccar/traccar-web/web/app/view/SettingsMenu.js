...
Ext.define('Traccar.view.SettingsMenu', {
    ...
    menu: {
        ...
        items: [{
            ...
            text: Strings.settingsAllDevices,
            glyph: 'xf14e@FontAwesome',
            handler: 'onAllDevicesClick',
            reference: 'settingsAllDevicesButton'
        }, {
            /* Add scheduling option to devices menu- added by Jack*/
            hidden: true,
            text: Strings.settingsSchedules,
            glyph: 'xf017@FontAwesome',
            handler: 'onSchedulesClick',
            reference: 'settingsSchedulesButton'
        }, {
            hidden: true,
