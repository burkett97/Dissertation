...
Ext.define('Traccar.view.SettingsMenuController', {
    ...
    requires: [
        ...
        'Traccar.view.edit.AllDevices', // Added by Jack- allows to add alldevices window by connecting to alldevicesView
        'Traccar.view.edit.Schedules', // Added by Jack- allows to add schedule window by connecting to schedulesView
    ...
    init: function() {
        ...
        if (admin || !readonly) {
            ...
            this.lookupReference('settingsSchedulesButton').setHidden(false);
    ...
    onAllDevicesClick: function() {
        Ext.create('Traccar.view.BaseWindow', {
            title: Strings.settingsAllDevices,
            items: {
