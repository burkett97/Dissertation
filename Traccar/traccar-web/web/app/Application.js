...
Ext.define('Traccar.Application', {
    ...
    models: [
        'Server',
        'User',
        'Schedule', // Added by Jack
        'AllDevices', // Added by Jack
        'Group',
        'Device',
        'Position',
        'Attribute',
    ...
    stores: [
        'SchedulePeriods', // Added by Jack
        'SchedulePeriodsDays', // Added by Jack
        'SchedulePeriodsFormat', // Added by Jack
        'ScheduleTimings', // Added by Jack
        'ScheduleTimingsFormat', // Added by Jack
        'AllSchedules', // Added by Jack
        'AllRegDevices', // Added by Jack
        'Groups',
        'Devices',
        'AllGroups',
        'AllDevices',
