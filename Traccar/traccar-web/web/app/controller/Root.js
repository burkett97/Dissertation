...
Ext.define('Traccar.controller.Root', {
    ...
    loadApp: function() {
        ...
        var allschedules = Ext.getStore('AllSchedules'); // Added by Jack
        var userid = Traccar.app.getUser().get('id'); // Added by Jack
        allschedules.getProxy().setExtraParam('id', userid); // Added by Jack
        allschedules.load(); // Added by Jack
        var alldevices = Ext.getStore('AllRegDevices'); // Added by Jack
        var userid = Traccar.app.getUser().get('id'); // Added by Jack
        alldevices.getProxy().setExtraParam('id', userid); // Added by Jack
        alldevices.load(); // Added by Jack
