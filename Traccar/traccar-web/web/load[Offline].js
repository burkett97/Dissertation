(function() {
    ...
    if (debugMode) {
        addScriptFile('/Traccar_Offline/ExtJS-6.2.0/ext-all-debug.js');
        addScriptFile('/Traccar_Offline/ExtJS-6.2.0/charts-debug.js');
    } else {
        addScriptFile('/Traccar_Offline/ExtJS-6.2.0/ext-all.js');
        addScriptFile('/Traccar_Offline/ExtJS-6.2.0/charts.js');
    }
    addScriptFile('/Traccar_Offline/ExtJS-6.2.0/locale-en.js');


    // addStyleFile('https://cdnjs.cloudflare.com/ajax/libs/extjs/' + extjsVersion + '/classic/theme-triton/resources/theme-triton-all.css');
    addStyleFile('/Traccar_Offline/ExtJS-6.2.0/css/theme-triton-all.css');
    // addStyleFile('/Traccar_Offline/fontawesome.css');
    addScriptFile('/Traccar_Offline/ExtJS-6.2.0/theme-triton.js');
    ...
    // addStyleFile('/Traccar_Offline/ExtJS-6.2.0/charts-all.css');

    // addStyleFile('/Traccar_Offline/Ol-5.3.0/ol.css');
    addScriptFile('/Traccar_Offline/Ol-5.3.0/ol.js');

    if (debugMode) {
        addScriptFile('/Traccar_Offline/Proj4-2.5.0/proj4-src.js');
    } else {
        addScriptFile('/Traccar_Offline/Proj4-2.5.0/proj4.js');
    }
